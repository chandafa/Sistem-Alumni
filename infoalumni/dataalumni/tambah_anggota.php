									...
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nama_panggilan" id="nama_panggilan" required class="form-control" placeholder="Nisn" onchange="auto_username(this.value)" onkeyup="cek_nama_panggilan(this.value)">
													<p class="form-control-static text-danger" id="info_nama_panggilan"></p>
													<p class="form-control-static" id="saran_nama_panggilan"></p>
													<span class="help-block">Nisn di isi dengan benar karena akan digunakan sebagai username untuk dapat masuk ke dalam sistem ini.</span>
												</div>
											</div>
											<!-- Jenis Kelamin -->
											<div class="form-group">
...
<script type="text/javascript">
	...
	function cek_nama_panggilan (nama_panggilan) {
		if (nama_panggilan!="") {
			...
			$("#info_nama_panggilan").html("Harap isikan nisn Anda!");
			$("#proses_simpan").hide('slow');
		}
	}
